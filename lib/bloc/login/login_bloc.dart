...
class LoginBloc extends Bloc<LoginEvent, LoginState> {
  ...
  LoginBloc({required AuthRepositories authRepositories, required AuthBloc authBloc})
  ...
  void _onLoginExecuted(LoginButtonPressed event, Emitter<LoginState> emit) async {
    try {
      emit(LoginLoading());
